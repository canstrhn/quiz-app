...
import 'package:cet_quiz_app/Service/QuizManager.dart';
import 'package:cet_quiz_app/screens/ResultPage.dart';
...
class _QuizPageState extends State<QuizPage> {
  ...
  List<Widget>getOption( Question question){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Soru ${_manager.getCurrentId()}/ ${_manager.totalQuestionNumber()}',
      ),),
      body: Container(
          ...
          children: [
            ...
            Expanded(
              ...
              child: Container(
                ...
                children: getOption(_manager.getCurrentQuestion()),
